    ...
    return (
      <div className="bg-white rounded-lg shadow p-4">
        <div className="text-center py-6">
          ...
          <button onClick={() => setShowManageModal(true)} className="mt-2 text-sm text-blue-600 hover:text-blue-800">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Configure quick sale items from the Products page by using the "Add to Quick Sale" option.
            </p>
            <Button variant="primary" onClick={() => setShowManageModal(false)}>
              Close
            </Button>
          </div>
        </div>
