    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex flex-col items-center justify-center h-64 text-red-500">
          ...
          <button onClick={fetchOffers} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
            Retry
          </button>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        {offers.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-500 text-sm">Check back later for exciting promotions!</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span
                            className={`px-2 py-1 rounded text-xs font-medium ${getOfferTypeBadge(offer.offerType)}`}
                          >
                            {getOfferTypeLabel(offer.offerType)}
                          </span>
                        </div>

                        <div className="text-3xl font-extrabold text-blue-600 mb-2">{formatDiscountValue(offer)}</div>

                        {offer.description && <p className="text-sm text-gray-600 mb-3">{offer.description}</p>}
                    ...
                    {eligible && active && (
                      <div className="mt-3 text-sm text-green-600 font-medium">✓ You're eligible for this offer!</div>
                    )}
                  </div>
                </div>
              );
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-purple-500 p-6 rounded-lg mb-4 text-white">
              <div className="text-4xl font-extrabold mb-2">{formatDiscountValue(selectedOffer)}</div>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              <p className="text-sm text-blue-800">
                <strong>How to use:</strong> This offer will be automatically applied at checkout when you meet the
                requirements.
              </p>
            </div>
